...
If (False:C215)
	...
	$extracted_o:=Extract(Extract Document DOCX; Extract Output Object; $task)
	//to extract raw text 
	$extracted_t:=Extract(Extract Document DOCX; Extract Output Text; $task)
End if 
...
{
"count": 835,
"average": "70.9 embeddings per second"
}
*/
